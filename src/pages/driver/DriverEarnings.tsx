    ...
    <div className="max-w-md mx-auto px-4 py-6 text-right text-slate-100 space-y-4 pb-24" id="driver-earnings-screen" dir="rtl">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400">سجل الأرباح الفعلية والرحلات المكتملة</p>
        </div>
      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-amber-500/30 rounded-3xl p-5 shadow-2xl space-y-4">
        ...
        <div className="bg-slate-950 border border-slate-800/80 rounded-2xl p-3.5 space-y-2 text-xs">
          ...
          <div className="flex items-center justify-between text-red-400">
            <span>عمولة المنصة المسجلة:</span>
            <span className="font-bold">- {formatCurrencyDZD(totalCommissionDZD)}</span>
          </div>
